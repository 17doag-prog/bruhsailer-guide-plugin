...
public class CountingGraphics2D extends Graphics2D
{
	private final AtomicInteger drawPolygonCount = new AtomicInteger(0);
	private final AtomicInteger drawOvalCount = new AtomicInteger(0);
	private final AtomicInteger fillPolygonCount = new AtomicInteger(0);
	private final AtomicInteger fillOvalCount = new AtomicInteger(0);

	public int getDrawPolygonCount()
	{
		return drawPolygonCount.get();
	}

	public int getDrawOvalCount()
	{
		return drawOvalCount.get();
	}

	public int getFillPolygonCount()
	{
		return fillPolygonCount.get();
	}

	public int getFillOvalCount()
	{
		return fillOvalCount.get();
	}

	public int getTotalDrawCount()
	{
		return drawPolygonCount.get() + drawOvalCount.get() + fillPolygonCount.get() + fillOvalCount.get();
	}

	@Override
	public void drawPolygon(Polygon p)
	{
		drawPolygonCount.incrementAndGet();
	}
	...
	{
		fillPolygonCount.incrementAndGet();
	}
	...
	{
		drawOvalCount.incrementAndGet();
	}

	@Override
	public void fillOval(int x, int y, int width, int height)
	{
		fillOvalCount.incrementAndGet();
	}
	...
	// --- No-op overrides for remaining abstract methods ---
	...
	@Override
	public FontRenderContext getFontRenderContext() { return new FontRenderContext(null, false, false); }
	...
	@Override
	public Stroke getStroke() { return new java.awt.BasicStroke(); }
	...
	@Override
	public Graphics create() { return new CountingGraphics2D(); }
